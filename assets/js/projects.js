const projects = {
    ...
    thesis:{
        ...
        gallery:[
        "assets/img/ta/grafik_dl.webp",
        "assets/img/ta/curve.webp",
        "assets/img/ta/cm.webp",
        "assets/img/ta/pipeline.webp"
        ],
        overview:
    ...
    magistra:{
        ...
        gallery:[
        "assets/img/magistra/mag-login.webp",
        "assets/img/magistra/magistra-db.webp",
        "assets/img/magistra/magistra-form-jadwal.webp",
        "assets/img/magistra/mag-jadwal.webp",
        "assets/img/magistra/mag-irs.webp",
        "assets/img/magistra/mag-kelola-matkul.webp",
        ],
        overview: 
    ...
    segmentation:{
        ...
        gallery:[
        "assets/img/segmentation/streamlit.webp",
        "assets/img/segmentation/elbow curve.webp",
        "assets/img/segmentation/boxplot.webp",
        "assets/img/segmentation/cluster0.webp",
        "assets/img/segmentation/cluster1.webp",
        "assets/img/segmentation/cluster2.webp"
        ],
    ...
    music:{
        ...
        timeline: "Dec 2025",
        gallery:[
        "assets/img/music/pipeline.webp",
        "assets/img/music/waveform.webp",
        "assets/img/music/corrmap.webp",
        "assets/img/music/pca.webp",
        "assets/img/music/cm.webp",
        ],
    ...
    lanjan:{
        ...
        gallery:[
        "assets/img/lanjan/landing-page.webp",
        "assets/img/lanjan/tentang.webp",
        "assets/img/lanjan/sejarah.webp",
        "assets/img/lanjan/katalog-petani.webp",
        "assets/img/lanjan/katalog-inovasi.webp",
        "assets/img/lanjan/kisah-unik.webp",
        "assets/img/lanjan/pak-sujadi.webp",
        "assets/img/lanjan/artikel.webp",
        "assets/img/lanjan/artikel-1.webp",
        ],
    ...
    sentiment:{
        ...
        timeline: "May 2025",
        gallery:[
        "assets/img/tokped/wordcloud.webp",
        "assets/img/tokped/distribusi-sentiment.webp",
        "assets/img/tokped/lr.webp",
        "assets/img/tokped/svm.webp",
        ],
    ...
    sikecil:{
        ...
        gallery:[
        "assets/img/sikecil/Poster-1.webp",
        "assets/img/sikecil/1.webp",
        "assets/img/sikecil/2.webp",
        "assets/img/sikecil/3.webp",
        "assets/img/sikecil/4.webp",
        ],
